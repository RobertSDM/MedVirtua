        ...
        <div className="w-full flex flex-col py-10 items-center max-w-sm mx-auto gap-y-10 md:max-w-md">
            <section className="w-full flex justify-between items-center">
                <span className="text-sm text">
                    Criado por: {vaccine.madeBy}
                </span>
                <Button
                    link={`/calendar/chat/${vaccineId}`}
                    text="tirar duvida"
                    size="w-24 h-10"
                    extraStyle="text-xs font-bold"
                />
            </section>
            <section className="w-full space-y-10">
                <div>
                    <h2 className="font-bold">
                        Vacina:{" "}
                        <span className="font-normal">{vaccine.name}</span>
                    </h2>
                    <p className="text-sm font-bold">
                        Data:{" "}
                        <span className="font-normal">
                            {vaccine.day}/{vaccine.month}/{vaccine.year}
                        </span>
                    </p>
                </div>
            ...
            <section className="space-y-5 w-full">
                <div className="space-y-3">
                    <p className="text-sm font-bold">
                        Local:{" "}
                        <span className="font-medium">{vaccine.place}</span>
                    </p>
                    <Image
                        src="https://i.blogs.es/b68133/4urb5gipmfhw3ku55p7hkkrpue/450_1000.webp"
                        width={1000}
                        height={1000}
                        alt="Google maps"
                        className="w-full aspect-auto border-2 rounded-md"
                    />
                </div>
